...
//WRN - instead of doing all this work here, why not make it styles? CSS
//   All you need to do once you have 5x2 styles is:  	$(".pageTab").addClass("captain")
...
//WRN - might be a place to use $.toggleClass( "captainSelect daveySelect")	
	//Set correct bookspine highlight
...
/*
var currentID = $(this).attr("categoryID");
$(".pageTab").each(function(index) {
	if ($(this).attr("categoryID") == currentID) {
